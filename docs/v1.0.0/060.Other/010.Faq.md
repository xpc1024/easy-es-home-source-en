...
In order to ensure the native flexibility of the pure self mapping scenario, all information such as the index type is specified by the user, not user-defined annotations
