...
It is planned to complete the official release of version 2.0 this year (2023), because this version 2.0 has changed a lot, the core code has been changed almost once, and 2.x has brought a lot of new features compared with 1.x.
It can be called thoroughly remould oneself. In order to ensure the stability and reliability of the official version of 2.0.0 and win the reputation for EE, we will push it with multiple beta versions.
- v2.0.0-beta1
- v2.0.0-beta2
- v2.0.0-beta 
- v2.0.0 Push the official version.

We are striving for continuous improvement, and we always welcome everyone with lofty ideals to join us. ...
