...
## v2.0.0-beta6
- Added parent-child type index automation support for scenarios of one parent with multiple children and one parent with multiple children and multiple grandchildren (major feature)
- Added support for all query functions of parent and child types (major feature)
- Provide a brand-new custom annotation @Settings, support convenient preset and flexible customization, and support convenient handling of all settings in ES index (significant feature).- All CRUD methods support method-granular custom routing functionality
- Added routing printing in DSL statement printing
- javadoc and comments and optimization of some code details
