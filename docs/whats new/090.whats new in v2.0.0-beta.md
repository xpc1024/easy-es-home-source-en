...
The function of introducing jackson into fastjson is postponed to beta3.
...
The above is only a plan, the actual version will be adjusted according to the defects and new features flexible, but the overall plan as a reference
