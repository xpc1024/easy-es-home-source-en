...
> **Warm Tips:** Novices can try to choose the manual shift mode as far as possible. Old drivers (familiar with the principle and source code of each mode) please feel free to pursue the stability of the production environment. We suggest that you adopt the manual shift mode. Our manual shift also provides a very friendly one-button creation function, which is also sweet to use. Automatic shift mode, it is recommended that you fully understand its operating principle and source code before production, otherwise many white people will not understand the principle and how to correctly configure it.
